...
# === Config ===
MODEL_PATHS = [
    "adformer_id_c_v1.pth",
    "adformer_id_c_v2.pth",
    "adformer_id_c_v3.pth",
    "adformer_id_c_v4.pth",
    "adformer_id_c_v5.pth"
]
H5_PATH = "/workspace/memory_os_ai/alz/eeg_data_alzheimer_99_id_C.h5"
SAVE_DIR = "/workspace/memory_os_ai/ad_id_99_c/"
...
plt.colorbar()
plt.xticks(ticks=[0,1,2], labels=["Début", "Modéré", "Avancé"])
plt.yticks(ticks=[0,1,2], labels=["Début", "Modéré", "Avancé"])
plt.tight_layout()
